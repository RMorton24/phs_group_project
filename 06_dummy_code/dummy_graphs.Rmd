...
```{r}
hospital_beds <- read_csv('PDA_Project2/hospital_covid_data/hospital_covid_data/beds_by_nhs_board_of_treatment_and_specialty.csv') %>% clean_names()
hospital_admissions <- read_csv('PDA_Project2/hospital_covid_data/hospital_admissions_hb_simd_20220302.csv') %>% clean_names()
hospital_demographics <- read_csv('PDA_Project2/hospital_covid_data/hospital_covid_data/hospital_admissions_hscp_agesex_20220302(2).csv') %>% clean_names()
waiting_times <- read_csv('PDA_Project2/hospital_covid_data/hospital_covid_data/monthly_ae_waitingtimes_202206.csv') %>% clean_names()
hospital_specialty <- read_csv('PDA_Project2/hospital_covid_data/hospital_covid_data/inpatient_and_daycase_by_nhs_board_of_treatment_and_specialty.csv') %>% clean_names()
hospital_impatients <- read_csv('PDA_Project2/hospital_covid_data/hospital_covid_data/inpatient_and_daycase_by_nhs_board_of_treatment_age_and_sex.csv')
```
